...
:::info
We understand that security conscious users may prefer not to use `curl | shell` syntax, [manual install options here](https://packagecloud.io/crowdsec/crowdsec/install#manual)
:::
